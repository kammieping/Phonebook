...
public class StudentTests {
    ...
    public void testSepChain() {
    	...
    	SeparateChainingHashTable tab = new SeparateChainingHashTable();
    	tab.put("Key", "Test1");
    	tab.put("Key2","Test2");
    	
    	System.out.println("Cap: " + tab.capacity() + " size: " + tab.size());
    	tab.enlarge();
    	System.out.println("enlarge: " + tab.capacity()+ " size: " + tab.size());
    	tab.shrink();
    	System.out.println("shrink: " + tab.capacity()+ " size: " + tab.size());
    }*/
    @Test
    public void testQuadProb() {
    	QuadraticProbingHashTable tab = new QuadraticProbingHashTable(false);
    	tab.put("Test1", "Val1");
    	tab.put("Test2", "Val2");
    	tab.put("Test3", "Val3");
    	tab.put("Test4", "Val4");
